                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="space-y-6 text-xl font-normal leading-relaxed opacity-90 max-w-xl">
                            ...
                            <p>
                                Here&apos;s the dirty secret of answering services: you aren&apos;t their only client. When a storm hits, all their clients get slammed at once. Their staff gets overwhelmed, and your customers end up waiting in line behind your competitors.
                            </p>
