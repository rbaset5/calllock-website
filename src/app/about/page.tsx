...
const values = [
    {
        icon: Target,
        title: "Speed to Lead",
        description: "In HVAC, the first person to answer wins the job. We make sure that person is always you."
    },
    {
        icon: ShieldCheck,
        title: "Reliability",
            ...
            <section className="pt-24 pb-20 lg:pt-32 lg:pb-40 bg-background-light dark:bg-[#1c1a12] relative overflow-hidden">
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tight">
                        We Help HVAC Pros <br /><span className="text-primary italic">Capture Every Opportunity.</span>
                    </h1>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
                        <div>
                            ...
                            <div className="space-y-6 text-lg text-muted font-medium leading-relaxed">
                                <p>
                                    We saw a pattern in the HVAC industry: great technicians were losing thousands in revenue every month because they couldn&apos;t answer the phone while on a job.
                                </p>
                                <p>
